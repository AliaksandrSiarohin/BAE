...
def parse_args():
    ...
    parser.add_argument("--image_shape", type=lambda x: tuple(map(int, x.split(','))), default=(3, 256, 256),
                        help="Shape of the resulting image")
    parser.add_argument("--lr", type=float, default=0.1,
                                            help="Learning rate for Gradient Accent,"
                                                 "tao for Langevein Dynamycs,"
                                                 "transition var for MetropolisHastings")
    ...
    parser.add_argument("--score_type", choices=['blue', 'mem', 'aes', 'scary', 'gloomy', 'happy', 'peaceful'], default='mem',
    ...
    parser.add_argument("--content_images_folder", default='dataset/lamem/images/',
                        help="Content images for evaluation")
    parser.add_argument("--content_images_names_file",
                        default='dataset/memorability_test_images.txt',
                        help="File with content image names")
